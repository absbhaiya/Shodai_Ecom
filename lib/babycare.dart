...
class _BabyCareScreenState extends State<BabyCareScreen> {
  String selectedSubCategory = 'Bath & Skincare';
  ...
  Widget _buildSubCategorySection() {
    return Container(
      ...
      child: SingleChildScrollView(
        ...
        child: Row(
          children: [
            _buildCategoryChip('Bath & Skincare'),
            _buildCategoryChip('Baby Wipes'),
  ...
  Widget _buildOffersSection(
    ...
    return Container(
      ...
      child: Column(
        children: [
          _buildOffersList(babycards, cartController, favoritesProvider),
  ...
  Widget _buildOffersList(List<Map<String, dynamic>> babycards,
      CartController cartController, FavoritesProvider favoritesProvider) {
